...
namespace ActivitiesManagement.Controllers
{
    ...
    {
        private readonly VisaApplicationRepository _repo;

        public VisaApplicationController(VisaApplicationRepository repo)
        {
            _repo = repo;
        }
        ...
        {
            if (id == null)
                return View(new VisaApplication());
        ...
        public IActionResult AddEdit(VisaApplication model, string action)
        {
            ...
            if (model.Id == 0)
            {
                ...
                TempData["SaveMessage"] = "Visa application saved successfully.";
            }
            else
            {
                _repo.Update(model, CurrentUserId);
                TempData["SaveMessage"] = "Visa application updated successfully.";
            }
