...
namespace ActivitiesManagement.Controllers
{
    public class InterviewController : Controller
    {
        ...
        public InterviewController(InterviewRepository repo)
        {
            _repo = repo;
        }
        ...
        public IActionResult AddEdit(Interview model, string action)
        {
            ...
            if (model.Id == 0)
            {
                ...
                TempData["SaveMessage"] = "Interview master saved successfully.";
            }
            else
            {
                _repo.Update(model, CurrentUserId);
                TempData["SaveMessage"] = "Interview master updated successfully.";
            }
